...
See [create-fedimint-app](https://github.com/fedimint/fedimint-sdk/tree/main/js/tools/create-fedimint-app) for more details on each supported template.
...
See setup guides for some popular choices below. If your tool is not listed or the setup does not work, feel free to [open an issue](https://github.com/fedimint/fedimint-sdk/issues/new) or [contribute a guide](https://github.com/fedimint/fedimint-sdk/edit/main/js/docs/core/getting-started.md).
...
Check out the [nextjs sample app](https://github.com/fedimint/fedimint-sdk/tree/main/js/examples/next-js) for a full working example.
...
See the [bare-js sample app](https://github.com/fedimint/fedimint-sdk/tree/main/js/examples/bare-js) for a full working example.
